...
- Clean, modern UI (React) to capture product idea, business goals, and constraints.
- Real-time visualization of generated artifacts (Problem Statement -> PRD -> Stories -> Sprint Plan).
